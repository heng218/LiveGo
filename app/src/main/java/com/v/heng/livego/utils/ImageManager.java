...
public class ImageManager {
    ...
    private static final int DISK_CACHE_SIZE = 1024 * 1024 * 4; // 4MB
    private static final String DISK_CACHE_SUBDIR = "xiakepai";
                ...
                case MSG_REQUEST: // 收到请求
                    try {
                        ...
                        if (msg.obj != null && msg.obj instanceof ImageRef) {
                            ...
                            if (bitmap != null) {  //sdcard 读到bitmap 写人缓存
...
//                                            mDiskCache.put(url, bitmap);
     ...
     * @return
     */
    private byte[] loadByteArrayFromNetwork(String urlStirng) {
        try {
...
//            return EntityUtils.toByteArray(entity);
    ...
    public String urlToFilePath(String url) {
        ...
        // 图片文件名
        filePath.append(Utils.md5(url)).append(url.substring(index));
